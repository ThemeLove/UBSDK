...
import com.umbrella.game.ubsdk.utils.BackgroundUtil;
import com.umbrella.game.ubsdk.utils.ImageBase64Util;
import com.umbrella.game.ubsdk.utils.ScreenUtil;
...
public class UBLoadingDialog extends Dialog{
	...
	public UBLoadingDialog(Activity activity, String msg) {
		super(activity);
