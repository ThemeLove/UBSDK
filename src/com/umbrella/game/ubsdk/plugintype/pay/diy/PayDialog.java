...
public class PayDialog extends Dialog{
	...
	private void initView() {
		mContainer = mInflater.inflate(ResUtil.getLayoutId(mContext, "ubsdk_pay_dialog_pay"), null);
		...
		mPayUserName = (TextView) mContainer.findViewById(ResUtil.getViewID(mContext,"tv_payUserName"));
		...
		mPayBtn = (Button) mContainer.findViewById(ResUtil.getViewID(mContext,"btn_pay"));
...
//        onWindowAttributesChanged(lp);
	...
	private void setListener() {
		...
		mPayBtn.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				if (mPayDialogClickListener!=null&&mCurrentPayMethodItem!=null) {
...
//		更新支付按钮状态
	 ...
	 * @param payType
	 */
	private void updatePayBtnStatus(PayMethodItem payItem){
		mPayBtn.setEnabled(true);
		mPayBtn.setClickable(true);
		mPayBtn.setText(payItem.getName());
	}
